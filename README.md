...
![标准的脉冲星搜寻方法](F:\FPGA\xup\project\标准的脉冲星搜寻方法.png)
...
![消色散算法流程](F:\FPGA\xup\project\消色散算法流程.png)
...
![模拟脉冲星](F:\FPGA\xup\project\模拟脉冲星.png)

- 经过消色散后的脉冲星数据流程

![模拟消色散](F:\FPGA\xup\project\模拟消色散.png)
...
![流水线](F:\FPGA\xup\project\流水线.png)
